...
**Chirp** is an android app that allows a user to perform several activities on Twitter. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
